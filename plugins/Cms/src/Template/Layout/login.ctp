...
<?php if(!empty($abacate)) : ?>
            <nav class="navbar navbar-default">
              <div class="container">
                  <a class="navbar-brand pull-right" href="<?php echo $this->Html->url('/'); ?>" style="padding: 0px;">
                      <img src="<?php echo $this->Html->url('/img/logo.png'); ?>" style="height: 44px; margin-top: 2px;" alt="">
                  </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h1 class="titulo-painel">Painel de Controle <small>
                            <?php echo AuthComponent::user("email"); ?></small></h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="lista-sidebar">
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => true, 'plugin' => false, 'controller' => 'admin', 'action' => 'users') ); ?>"> <i class="fa fa-user"></i> Listar Usuários</a>
                            </li>
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => true, 'plugin' => false, 'controller' => 'admin', 'action' => 'add_user') ); ?>"><i class="fa fa-user-plus"></i> Adicionar Usuário</a>
                            </li>
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => false, 'plugin' => 'users', 'controller' => 'users', 'action' => 'logout') ); ?>"><i class="fa fa-sign-out"></i> Sair</a>
                            </li>
                        </ul>
                        <h2 class="subtitulo-painel">Cadastro de Promoções</h2>

                        <ul class="lista-sidebar">
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => true, 'plugin' => false, 'controller' => 'admin', 'action' => 'promotions') ); ?>"> <i class="fa fa-pencil-square-o"></i> Listar Promoções</a>
                            </li>
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => true, 'plugin' => false, 'controller' => 'admin', 'action' => 'add_promotion') ); ?>"> <i class="fa fa-plus-square"></i> Criar Promoção</a>
                            </li>
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => true, 'plugin' => false, 'controller' => 'admin', 'action' => 'clients') ); ?>"><i class="fa fa-folder"></i> Clientes</a>
                            </li>
                        </ul>
                        <h2 class="subtitulo-painel">Registro de Cupons</h2>

                        <ul class="lista-sidebar">
                            <li>
                                <a href="<?php echo $this->Html->url( array('admin' => true, 'plugin' => false, 'controller' => 'admin', 'action' => 'coupons') ); ?>"> <i class="fa fa-pencil-square-o"></i> Histórico</a>
                            </li>
                        </ul>
                    </div>
